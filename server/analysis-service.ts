...
export async function analyzeStartupIdeaStepByStep(
  ...
  try {
    ...
    // Helper function to make structured API calls
    ...
    try {
          ...
          "competitors": [
            {
              ...
              "strengthDescription": string (detailed strength analysis),
              "weaknessDescription": string (detailed weakness analysis)
            },
          ...
          "segments": [
            {
              ...
              "sizeBillion": number (realistic market size in billions),
              "growthRate": number (yearly growth percentage),
              "currency": string (3-letter code),
              "addressablePercentage": number (realistic % of total addressable market),
              "potentialRevenue": number (potential annual revenue)
            },
      ...
      if (marketResult.marketSize) {
        ...
        // Ensure currency field exists in all market segments
        if (analysisResults.marketSize.segments) {
          analysisResults.marketSize.segments = analysisResults.marketSize.segments.map(segment => ({
            ...segment,
          ...
          "components": [
            {
              ...
              "strength": string (specific strength),
              "weakness": string (specific weakness),
              "improvement": string (specific improvement)
            },
          ...
          "segments": [
            {
              ...
              "sizeMillion": number (realistic population size in millions),
              "fitScore": number (0-100 fit score),
              "needsFulfilled": [array of specific needs this segment has],
              "acquisitionChannels": [array of specific acquisition methods]
            },
          ...
          "failures": [
            {
              ...
              "avoidanceStrategy": string (how to avoid this pitfall)
            },
